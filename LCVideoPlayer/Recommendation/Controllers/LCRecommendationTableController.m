//
//  LCRecommendationTableController.m
//  LCVideoPlayer
//
...
#import "LCRecommendationTableViewCell.h"

@interface LCRecommendationTableController ()

@property (nonatomic, strong) NSArray<NSString *> *objects;

@end

@implementation LCRecommendationTableController
...
- (void)viewDidLoad {
    ...
    /**
     * 详细解释:https://www.jianshu.com/p/5f5c550d61a0
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    LCRecommendationTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:cellID];
    if (cell == nil) {
        cell = [[LCRecommendationTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:cellID];
    }
